/**
 * This function transform IGN coordinate from lambert 93 to WGS84
 * which is the one used in most of maps and GPS system
 */
export function lambert93ToWGS84(lambertE, lambertN) {
